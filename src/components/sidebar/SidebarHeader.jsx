            ...
            <div className='h-[50px] bg-indigo-300 dark:bg-dark_bg_2 flex items-center px-4'>
                ...
                <div className='w-full flex items-center justify-between'>
                    ...
                    <ul className='flex items-center gap-x-2.5'>
                        ...
                        <li>
                            <button className="btn-2">
                                <AiOutlineHistory size={22} className='dark:fill-dark_svg_1 fill-white' />
                            </button>
                        </li>
                        <li>
                            <button className="btn-2">
                                <IoIosChatbubbles size={22} className='dark:fill-dark_svg_1 fill-white' />
                            </button>
                        </li>
                        <li className='relative' onClick={() => setShowMenu((prev) => !prev)} >
                            <button className={`btn-2 ${showMenu ? "bg-dark_hover_1" : ""}`}>
                                <HiOutlineDotsVertical color='white' size={22} className='dark:fill-dark_svg_1 fill-white' />
                            </button>
                            {
